...
const servicesData = [
    {
        ...
        image_url: "https://images.unsplash.com/photo-1587293852726-70cdb56c2866?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        benefits: [
        ...
        products: [
            { name: "Zebra ZT411 Industrial Printer", description: "High-performance 4-inch industrial printer with 300 dpi resolution, ideal for manufacturing and logistics.", image: "https://images.unsplash.com/photo-1612815154858-60aa4c59eaa6?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Industrial Printer" },
            { name: "Honeywell Granit 1991i Scanner", description: "Ultra-rugged 2D imager scanner designed for extreme environments with superior scan performance.", image: "https://images.unsplash.com/photo-1588508065123-287b28e013da?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Barcode Scanner" },
            { name: "Zebra TC52 Mobile Computer", description: "Android-based mobile computer with advanced data capture for retail and field operations.", image: "https://images.unsplash.com/photo-1598327105666-5b89351aff97?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Mobile Computer" },
            { name: "TSC TTP-247 Desktop Printer", description: "Compact and affordable desktop thermal printer perfect for small to medium businesses.", image: "https://images.unsplash.com/photo-1612815154858-60aa4c59eaa6?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Desktop Printer" }
        ],
        useCases: [
    ...
    },
    {
        ...
        products: [
            { name: "VirosTrack WMS", description: "Complete warehouse management system with bin location tracking, pick-pack-ship workflows, and real-time dashboards.", image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Warehouse Management" },
            { name: "AssetGuard Pro", description: "Enterprise asset tracking solution with RFID integration, depreciation tracking, and maintenance scheduling.", image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Asset Management" },
            { name: "RetailSync POS", description: "Modern point-of-sale system with inventory sync, customer loyalty programs, and multi-store support.", image: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Point of Sale" },
            { name: "Custom API Gateway", description: "Middleware solution for seamless integration between legacy systems and modern cloud applications.", image: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Integration" }
        ],
        useCases: [
    ...
    },
    {
        ...
        brands: [],
        products: [
            { name: "Premium Wax Ribbons", description: "Cost-effective ribbons for standard paper labels. Ideal for shipping labels and general-purpose applications.", image: "https://images.unsplash.com/photo-1586075010923-2dd4570fb338?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Thermal Ribbon" },
            { name: "Wax-Resin Hybrid Ribbons", description: "Enhanced durability for synthetic labels. Perfect for product labeling and outdoor use.", image: "https://images.unsplash.com/photo-1586075010923-2dd4570fb338?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Thermal Ribbon" },
            { name: "Polyester Asset Tags", description: "Ultra-durable tags for IT assets, machinery, and equipment. Resistant to chemicals and extreme temperatures.", image: "https://images.unsplash.com/photo-1620916566398-39f1143ab7be?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Asset Tag" },
            { name: "Custom Pre-printed Labels", description: "Labels with your logo, warning symbols, or fixed text. Available in rolls or sheets.", image: "https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Custom Label" }
        ],
        useCases: [
    ...
    },
    {
        ...
        image_url: "https://images.unsplash.com/photo-1556761175-5973dc0f32e7?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
        benefits: [
        ...
        products: [
            { name: "Basic AMC Plan", description: "Annual preventive maintenance with priority support. Excludes spare parts.", image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Service Plan" },
            { name: "Comprehensive AMC", description: "All-inclusive plan covering labor, parts, and unlimited service calls.", image: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Service Plan" },
            { name: "On-Demand Repair", description: "Pay-per-incident repair service with 24-48 hour response time.", image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Service Plan" },
            { name: "Remote Support Package", description: "Unlimited remote troubleshooting and software updates for your devices.", image: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Service Plan" }
        ],
        useCases: [
    ...
    },
    {
        ...
        products: [
            { name: "Dell Latitude 5430 Laptop", description: "14-inch business laptop with Intel i5, 16GB RAM, 512GB SSD. Perfect for office work and remote teams.", image: "https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Laptop" },
            { name: "HP EliteDesk 800 Desktop", description: "Compact desktop workstation with Intel i7, 32GB RAM, ideal for CAD and design work.", image: "https://images.unsplash.com/photo-1587831990711-23ca6441447b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Desktop" },
            { name: "MacBook Pro 14-inch", description: "M3 Pro chip, 18GB RAM, 512GB SSD. For creative professionals and developers.", image: "https://images.unsplash.com/photo-1517336714731-489689fd1ca8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Laptop" },
            { name: "Lenovo ThinkStation P360", description: "Professional workstation for engineering, 3D rendering, and data analysis.", image: "https://images.unsplash.com/photo-1587831990711-23ca6441447b?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80", category: "Workstation" }
        ],
        useCases: [
...
const productsData = [
    {
        ...
        slug: "industrial-label-printer-zt411",
        category: "Printers",
    ...
    },
    {
        ...
        slug: "handheld-scanner-ds2200",
        category: "Scanners",
        image_url: "https://images.unsplash.com/photo-1556742502-ec7c0e9f34b1?auto=format&fit=crop&w=800&q=80",
...
async function migrate() {
    ...
    try {
        ...
        // Clear existing data (optional, but good for a fresh start during migration development)
        ...
        for (const service of servicesData) {
            await connection.query(`
                INSERT INTO services (slug, title, description, long_description, icon_name, gradient, image_url, features, benefits, specifications, process, faqs, brands, products, useCases)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            `, [
                service.slug,
                service.title,
                ...
                JSON.stringify(service.brands || []),
                JSON.stringify(service.products || []),
                JSON.stringify(service.useCases || [])
            ]);
        }
        ...
        for (const product of productsData) {
            await connection.query(`
                INSERT INTO products (slug, name, category, description, tagline, image_url, theme_color, specs, is_featured)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
            `, [
                product.slug,
                product.name,
