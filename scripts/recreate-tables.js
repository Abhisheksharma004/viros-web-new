...
async function recreateTables() {
    ...
    try {
        ...
        await connection.query('DROP TABLE IF EXISTS testimonials');
        await connection.query('DROP TABLE IF EXISTS hero_slides');
        ...
        console.log('✓ Partners table working:', partners.length, 'rows');
        const [clients] = await connection.query('SELECT * FROM clients');
        console.log('✓ Clients table working:', clients.length, 'rows');
        const [testimonials] = await connection.query('SELECT * FROM testimonials');
        console.log('✓ Testimonials table working:', testimonials.length, 'rows');
