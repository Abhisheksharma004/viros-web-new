...
INSERT INTO users (email, name, password) VALUES ('sales@virosentrepreneurs.com', 'Abhishek Kumar', '$2a$10$8k9.d8DqCj/E6L.u9Q7fXeYyvVf.fQYh.n8P.B/9U/J8Z/UqGzG6')
ON DUPLICATE KEY UPDATE password = VALUES(password), name = COALESCE(NULLIF(VALUES(name), ''), name);
