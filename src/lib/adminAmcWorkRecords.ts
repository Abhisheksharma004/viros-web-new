...
async function runEnsureAdminAmcWorkRecordsTable() {
    ...
    const migrations: Array<{ column: string; sql: string }> = [
        ...
        },
        {
            ...
            sql: `ALTER TABLE ${TABLE} ADD COLUMN ticket_number VARCHAR(120) NULL AFTER user_known_issue`,
        },
        {
            column: "user_issue_reporting_date",
            sql: `ALTER TABLE ${TABLE} ADD COLUMN user_issue_reporting_date DATE NULL AFTER ticket_number`,
        },
        {
