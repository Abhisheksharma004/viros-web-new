                        ...
                        <ul className="space-y-6">
                            ...
                            <li className="flex items-start">
                                ...
                                <div className="flex flex-col">
                                    <a href={`tel:${(contactInfo.general_phone || '').replace(/[^+\d]/g, '')}`} className="text-gray-400 hover:text-[#06b6d4] transition-colors font-medium">
                                        {(contactInfo.general_phone || '').replace(/\s+/g, '-')}
                                    </a>
                                </div>
                            </li>
                            <li className="flex items-start">
