                                    ...
                                    <div className="mt-12 pt-12 border-t border-white/10">
                                        ...
                                        <div className="flex space-x-4">
                                            ...
                                            {data.social_twitter && data.social_twitter !== '#' && (
                                                <a href={data.social_twitter} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#06b6d4] transition-colors duration-300 group">
                                            ...
                                            {data.social_linkedin && data.social_linkedin !== '#' && (
                                                <a href={data.social_linkedin} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#06b6d4] transition-colors duration-300 group">
                                            ...
                                            {data.social_facebook && data.social_facebook !== '#' && (
                                                <a href={data.social_facebook} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#06b6d4] transition-colors duration-300 group">
                                            ...
                                            {data.social_instagram && data.social_instagram !== '#' && (
                                                <a href={data.social_instagram} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#06b6d4] transition-colors duration-300 group">
                                            ...
                                            {data.social_youtube && data.social_youtube !== '#' && (
                                                <a href={data.social_youtube} target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-[#06b6d4] transition-colors duration-300 group">
