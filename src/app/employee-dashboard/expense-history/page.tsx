        ...
        <div className="mx-auto w-full min-w-0 max-w-6xl space-y-3 pb-2 sm:space-y-6 sm:pb-6">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
                <div className="min-w-0 rounded-2xl border bg-white p-2.5 shadow-sm ring-1 ring-emerald-200 sm:p-4">
                    ...
                    <p className="mt-1 text-xl font-black leading-none text-emerald-700 sm:mt-2 sm:text-3xl">
                ...
                <div className="min-w-0 rounded-2xl border bg-white p-2.5 shadow-sm ring-1 ring-emerald-200 sm:p-4">
                    ...
                    <p className="mt-1 truncate text-base font-black leading-none text-emerald-700 sm:mt-2 sm:text-2xl">
            ...
            <section className="overflow-hidden rounded-2xl border border-[#0a2a5e]/10 bg-white shadow-sm">
                <div className="border-b border-gray-100 px-3 py-3 sm:px-6 sm:py-4">
                    ...
                    <div className="mt-3 space-y-2 border-t border-gray-100 pt-3 sm:mt-4 sm:space-y-3 sm:pt-4">
                        ...
                        >
                            <div>
                                <label htmlFor="history_filter_from" className={expenseLabelClass}>
                                    From date
                                </label>
                                <input
                                    id="history_filter_from"
                                    type="date"
                                    value={filterFrom}
                            ...
                            <div>
                                <label htmlFor="history_filter_to" className={expenseLabelClass}>
                                    To date
                                </label>
                                <input
                                    id="history_filter_to"
                                    type="date"
                                    value={filterTo}
                ...
                <div className="px-3 py-3 sm:p-6">
                    {isLoading ? (
                        ...
                        <div className="flex flex-col items-center justify-center gap-3 px-2 py-12 text-center">
                            <CheckCircle2 className="h-10 w-10 text-gray-300" aria-hidden />
                            <p className="text-sm font-medium text-gray-600">No approved expenses this month</p>
                        </div>
                            ...
                            <div className="space-y-3 lg:hidden">
                                {filteredExpenses.map((exp) => (
                                    <button
                                        ...
                                        className="flex w-full flex-col gap-3 rounded-2xl border border-emerald-100 bg-white p-4 text-left shadow-sm touch-manipulation active:scale-[0.99]"
                                    >
                                        <div className="flex items-start justify-between gap-3">
