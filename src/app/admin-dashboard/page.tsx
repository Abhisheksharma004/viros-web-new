        ...
        return (
            <div className="rounded-xl border border-red-200 bg-red-50 px-4 py-8 text-center">
                ...
                <button
                    type="button"
                    onClick={() => void load()}
                    className="mt-4 inline-flex items-center gap-2 rounded-lg bg-[#0a2a5e] px-4 py-2 text-sm font-semibold text-white"
                >
                ...
                >
                    {data.birthdayCards.map((card) => (
                        <BirthdayWishCard
                            ...
                            className="min-h-[10.25rem] rounded-2xl sm:min-h-[11rem] sm:rounded-3xl"
                        />
                    ))}
                </div>
            ) : null}
                ...
                {stats.map((stat) => (
                    ...
                    >
                        <div className="flex items-start justify-between">
                            ...
                            <div
                                className={`flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${stat.color} text-white shadow`}
                            >
                                {stat.icon}
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        {quickActions.map((action) => (
                            <Link
                                key={action.title}
                                href={action.href}
                                className="group flex flex-col items-center justify-center gap-1.5 rounded-xl border-2 border-gray-100 p-3 text-center transition-all duration-200 hover:border-[#0a2a5e]/30 hover:bg-[#0a2a5e]/5"
                            >
