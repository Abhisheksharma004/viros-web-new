...
const INPUT =
    "h-10 rounded-lg border border-gray-300 bg-white px-3 text-sm font-semibold text-gray-900 shadow-sm outline-none focus:border-[#0a2a5e] focus:ring-2 focus:ring-[#0a2a5e]/20";
const TOOLBAR =
    "flex w-full flex-nowrap items-center gap-2 rounded-2xl border border-gray-100 bg-white p-3 shadow-sm";
const TOOLBAR_MIDDLE = "flex min-w-0 flex-1 items-center gap-2";
const BTN_EXPORT =
    "inline-flex h-10 min-w-0 flex-1 items-center justify-center gap-1.5 whitespace-nowrap rounded-lg border border-gray-300 bg-white px-2.5 text-xs font-bold text-gray-900 shadow-sm hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-60 sm:gap-2 sm:px-3 sm:text-sm";
const BTN_ACTION =
    "inline-flex h-10 shrink-0 items-center justify-center gap-1.5 whitespace-nowrap rounded-lg bg-[#06b6d4] px-4 text-xs font-bold text-white hover:bg-[#05a8b8] disabled:opacity-60 sm:text-sm";
                ...
                <div className="space-y-4 p-5">
                    {proof.photoUrl ? (
                        <button
                            ...
                            className={`mx-auto block overflow-hidden rounded-xl ring-2 ring-offset-2 transition hover:opacity-95 focus:outline-none focus:ring-2 focus:ring-[#06b6d4] ${
        ...
        <div className="mx-auto max-w-7xl space-y-6">
                    ...
                    <div className={TOOLBAR}>
                        <div className="flex shrink-0 items-center gap-2">
                            <button
                                type="button"
                                onClick={() => shiftDay(-1)}
                                className="flex h-10 w-9 shrink-0 items-center justify-center rounded-lg border border-gray-300 text-gray-800 hover:bg-gray-50"
                            ...
                            <button
                                ...
                                className="h-10 shrink-0 rounded-lg border border-[#0a2a5e]/20 bg-[#0a2a5e]/5 px-3 text-xs font-semibold text-[#0a2a5e] hover:bg-[#0a2a5e]/10"
                            >
                                Today
                            </button>
                        </div>
                                                ...
                                                <td className={`${TD} text-center`}>
                                                    {row.canMarkPresent ? (
                                                        <button
                                                            ...
                                                            className="inline-flex items-center gap-1.5 rounded-lg bg-[#06b6d4] px-3 py-2 text-xs font-bold text-white shadow-sm hover:bg-[#05a8b8] disabled:opacity-60"
                                                        >
            ...
            {tab === "employee" && (
                <div className="space-y-4">
                    ...
                    {employeeMeta && (
                        <div
                            className="rounded-2xl border border-gray-100 p-4 text-white shadow-sm sm:p-5"
                            style={{
                                background:
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
                    <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
                        ...
                        <textarea
                            ...
                            className="mt-1 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-900 placeholder:text-gray-600 outline-none focus:border-[#06b6d4] focus:ring-2 focus:ring-[#06b6d4]/30"
                        />
                        <div className="mt-5 flex gap-2">
                            <button
                                ...
                                className="flex-1 rounded-xl border border-gray-200 py-2.5 text-sm font-semibold text-gray-800 hover:bg-gray-50"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-[#06b6d4] py-2.5 text-sm font-bold text-white hover:bg-[#05a8b8] disabled:opacity-60"
                            >
                                {markingKey ? (
